...
Thank you for helping keep SkyHub and the people who self-host it safe.
...
SkyHub is self-hosted free software (AGPL-3.0): every operator runs their own
...
SkyHub is pre-1.0 and moves quickly. Security fixes land on `main`; please test
